...
def callback(message: pubsub_v1.subscriber.message.Message) -> None:
    ...
    future = publisher.publish(topic_path, json.dumps(message_data).encode('utf-8'), function="converted");
...
sub_filter = "attributes.function=\"filtered\""  # the condition used for filtering the messages to be recieved 
